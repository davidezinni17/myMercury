...
<% ArrayList<Evento> filteredEvent = (ArrayList<Evento>) request.getAttribute("searchEventList");

    for (Evento evento : filteredEvent) {
...
<a href="searchEvent.jsp">Esegui una nuova ricerca</a>
